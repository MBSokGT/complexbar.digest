...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Бинго
  const bingoTasks = ['Нарезать ингредиенты для салатов ножами Arcos','Сделать глинтвейн с новинкой от Pinch&Drop','Пить шампанское из бокалов Arc Reveal\'Up','Отметить Новый год по всем часовым поясам','Загадать заветное желание под бой курантов','Потанцевать под любимый трек года','Спеть в караоке в «Евгениче»','<a href="https://www.kinopoisk.ru/series/4481731/" target="_blank" style="color:inherit;text-decoration:none;">Посмотреть сериал «Медведь»</a>','Покататься на коньках','Прогуляться по пустым улицам утром 1 января','Позавтракать в «Горыныче»','Сформулировать одно желание на весь 2026 год'];
